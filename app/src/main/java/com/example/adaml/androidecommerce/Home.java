...
import com.example.adaml.androidecommerce.Model.Category;
import com.example.adaml.androidecommerce.Model.Item;
import com.example.adaml.androidecommerce.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Load Menu using Firebase UI to bind data to recycler view
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Category Selection CLick, Get CategoryId and send to new Activity
                        Intent itemList = new Intent(Home.this, ItemList.class);
                        //CategoryId is a key value
